...
public class Archer implements MenuItem {
    @Override
    ...
    public ItemStack getItem() {
        ...
        return ItemStack.builder(Material.BOW).displayName(holder.getName().decoration(TextDecoration.ITALIC, false)).lore(lore).meta(mb -> mb.hideFlag(ItemHideFlag.HIDE_ENCHANTS).hideFlag(ItemHideFlag.HIDE_ATTRIBUTES)).build();
    }

    private MenuItemHolder getMiniMessage() {
        MiniMessage mm = MiniMessage.miniMessage();
        Component name = mm.deserialize("<bold><dark_gray>Archer</dark_gray></bold>");
        List<Component> lore = new ArrayList<>();
