...
public class Mage implements MenuItem {
    @Override
    ...
    public ItemStack getItem() {
        ...
        return ItemStack.builder(Material.FIRE_CHARGE).displayName(holder.getName().decoration(TextDecoration.ITALIC, false)).lore(lore).meta(mb -> mb.hideFlag(ItemHideFlag.HIDE_ENCHANTS).hideFlag(ItemHideFlag.HIDE_ATTRIBUTES)).build();
    }

    private MenuItemHolder getMiniMessage() {
        MiniMessage mm = MiniMessage.miniMessage();
        Component name = mm.deserialize("<bold><red>Mage</red></bold>");
        List<Component> lore = new ArrayList<>();
        lore.add(mm.deserialize("<blue>Regeneration I.</blue>"));
        lore.add(Component.empty());
        lore.add(mm.deserialize("<blue>Launch fire charges.</blue>"));
        lore.add(Component.empty());
        lore.add(mm.deserialize("<blue>Freeze players using a</blue>"));
        lore.add(mm.deserialize("<blue>watch.</blue>"));
        lore.add(Component.empty());
